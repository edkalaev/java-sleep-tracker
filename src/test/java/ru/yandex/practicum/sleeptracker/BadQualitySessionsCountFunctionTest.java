...
class BadQualitySessionsCountFunctionTest {
    ...
    @Test
    void shouldReturnCountOfBadQualitySessions() {
        ...
        assertEquals("Количество сессий сна с плохим качеством", result.getDescription());
        assertEquals(2L, result.getValue());
    }

    @Test
    void shouldReturnZeroWhenThereAreNoBadQualitySessions() {
        List<SleepingSession> sessions = List.of(
                new SleepingSession(
                        LocalDateTime.of(2025, 10, 1, 22, 15),
                        LocalDateTime.of(2025, 10, 2, 8, 0),
